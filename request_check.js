...
function Parser(name, codes, var_obj, filename) {
  switch (name) {
    case "node":
      ...
      // console.log(codes);
      if (
        codes.includes("require") ||
        codes.includes("import") ||
        codes.includes("export") ||
        codes.includes("process") ||
        codes.includes("process") ||
        codes.includes("document.write") ||
        codes.includes("console.log")
      )
    ...
    case "python":
      ...
      if (
        ...
        codes.includes("open") ||
        codes.includes(".read") ||
        codes.includes(".write") ||
        codes.includes(".close") ||
        codes.includes("compile()" || codes.includes("input()")) ||
        codes.includes("detach()") ||
        codes.includes("fileno()") ||
        codes.includes("flush()") ||
        codes.includes("isatty()") ||
        codes.includes("readable()") ||
        codes.includes("readline()") ||
        codes.includes("readlines()") ||
        codes.includes("seek") ||
        codes.includes("seekable") ||
        codes.includes("tell()") ||
        codes.includes("truncate()") ||
        codes.includes("writeable()") ||
        codes.includes("write") ||
        codes.includes("writelines()") ||
        codes.includes("print(")
      )
        throw new Error(" contains invalid statements");
      else {
        console.log(codes);
    ...
    case "php":
      ...
      // console.log(codes);
      if (
        codes.includes("include") ||
        codes.includes("require") ||
        codes.includes("require_once") ||
        codes.includes("echo(")
      )
        throw new Error(" contains invalid statements");
      else {
